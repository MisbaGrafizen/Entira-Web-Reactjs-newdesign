...
export default function LatestTrends() {
    return (
        <>
            <section className='md:w-[88%] w-[100%] relative md:top-[-40%] top-[-60%]  bg-[#fff] mx-auto rounded-[15px] h-[100%]  '>
                        ...
                        <div className='md:w-[100%] w-[90%]  mx-auto md:pb-[30px] pb-[30px] flex md:flex-row flex-col gap-[10px] '>
                            <div className='flex flex-row md:flex-row'>
                                ...
                                <div className='md:w-[50%] rounded-[10px] p-[15px] hover:bg-[#fff3ec] transition duration-300  '>
                                    <img className=' md:max-w-[1500px] rounded-[10px]' src={arrival1} />
                                ...
                                <div className='md:w-[50%] rounded-[10px] p-[15px] hover:bg-[#fff3ec] transition duration-300  '>
                                    <img className=' md:max-w-[1500px] rounded-[10px]' src={arrival2} />
                                    <div className=' bg-[#eebca3] text-white rounded-[6px] md:rounded-[10px] py-[5px] md:py-[10px] mt-[25px] mx-auto text-center w-[100px] md:w-[130px]'>
                                        <p>
                                            Add to cart
                                        </p>
                            ...
                            <div className='w-[100%] flex flex-row md:flex-row'>
                                ...
                                <div className='md:w-[50%] rounded-[10px] p-[15px] hover:bg-[#fff3ec] transition duration-300  '>
                                    <img className=' md:max-w-[1500px] rounded-[10px]' src={arrival3} />
                                    <div className=' bg-[#eebca3] text-white rounded-[6px] md:rounded-[10px] py-[5px] md:py-[10px] mt-[25px] mx-auto text-center w-[100px] md:w-[130px]'>
                                        <p>
                                            Add to cart
                                        </p>
                                ...
                                <div className='md:w-[50%] rounded-[10px] p-[15px] hover:bg-[#fff3ec] transition duration-300  '>
                                    <img className=' md:max-w-[1500px] rounded-[10px]' src={arrival4} />
                                    <div className=' bg-[#eebca3] text-white rounded-[6px] md:rounded-[10px] py-[5px] md:py-[10px] mt-[25px] mx-auto text-center w-[100px] md:w-[130px]'>
                                        <p>
                                            Add to cart
                                        </p>
                    ...
                    <div className=' bg-[#eebca3] text-white rounded-[6px] md:rounded-[10px] py-[5px] md:py-[10px] mt-[25px] mx-auto text-center w-[100px] md:w-[130px]'>
                        ...
                        <div className='md:w-[100%] w-[90%]  mx-auto md:pb-[30px] pb-[30px] flex md:flex-row flex-col gap-[10px] '>
                            <div className='flex flex-row md:flex-row'>
                                ...
                                <div className='md:w-[50%] rounded-[10px] p-[15px] hover:bg-[#fff3ec] transition duration-300  '>
                                    <img className=' md:max-w-[1500px] rounded-[10px]' src={arrival5} />
                                    <div className=' bg-[#eebca3] text-white rounded-[6px] md:rounded-[10px] py-[5px] md:py-[10px] mt-[25px] mx-auto text-center w-[100px] md:w-[130px]'>
                                        <p>
                                            Add to cart
                                        </p>
                                ...
                                <div className='md:w-[50%] rounded-[10px] p-[15px] hover:bg-[#fff3ec] transition duration-300  '>
                                    <img className=' md:max-w-[1500px] rounded-[10px]' src={arrival6} />
                                    <div className=' bg-[#eebca3] text-white rounded-[6px] md:rounded-[10px] py-[5px] md:py-[10px] mt-[25px] mx-auto text-center w-[100px] md:w-[130px]'>
                                        <p>
                                            Add to cart
                                        </p>
                            ...
                            <div className='w-[100%] flex flex-row md:flex-row'>
                                ...
                                <div className='md:w-[50%] rounded-[10px] p-[15px] hover:bg-[#fff3ec] transition duration-300  '>
                                    <img className=' md:max-w-[1500px] rounded-[10px]' src={arrival7} />
                                    <div className=' bg-[#eebca3] text-white rounded-[6px] md:rounded-[10px] py-[5px] md:py-[10px] mt-[25px] mx-auto text-center w-[100px] md:w-[130px]'>
                                        <p>
                                            Add to cart
                                        </p>
                                ...
                                <div className='md:w-[50%] rounded-[10px] p-[15px] hover:bg-[#fff3ec] transition duration-300  '>
                                    <img className=' md:max-w-[1500px] rounded-[10px]' src={arrival8} />
